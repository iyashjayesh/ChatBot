...
IFontDisp = Font
__all__ = [ 'OLE_HANDLE', 'OLE_YPOS_PIXELS', 'Checked', 'VgaColor',
           'Font', 'FONTNAME', 'Picture', 'IFontEventsDisp',
           'OLE_XPOS_HIMETRIC', 'Default', 'Color',
           'OLE_YPOS_HIMETRIC', 'IPictureDisp', 'Unchecked', 'Gray',
           'FONTUNDERSCORE', 'IPicture', 'OLE_YSIZE_PIXELS',
           'OLE_YPOS_CONTAINER', 'FONTSIZE', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_CONTAINER', 'OLE_CANCELBOOL', 'OLE_TRISTATE',
           'StdFont', 'LoadPictureConstants', 'OLE_YSIZE_HIMETRIC',
           'StdPicture', 'OLE_COLOR', 'OLE_XSIZE_HIMETRIC',
           'OLE_XPOS_PIXELS', 'IFont', 'FONTITALIC', 'FontEvents',
           'FONTBOLD', 'Monochrome', 'OLE_YSIZE_CONTAINER',
           'OLE_XSIZE_PIXELS', 'FONTSTRIKETHROUGH', 'IFontDisp',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_CONTAINER']
